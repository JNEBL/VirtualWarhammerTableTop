 ...
 */
public class KabaliteTrueBorn extends DarkEldarModel {
    public KabaliteTrueBorn(){
        super(4,4,3,3,1,5,2,9,5,"Kabalite Trueborn","Kabalite " +
                ...
                "in the lairs of the Haemonculi, and so they prefer to kill from afar.",11);
        setElites(true);
        setInfantry(true);
        setFleet(true);
