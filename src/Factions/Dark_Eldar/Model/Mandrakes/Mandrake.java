 ...
 */
public class Mandrake extends DarkEldarModel{
    public Mandrake(){
        super(4,4,4,3,1,5,2,8,7,"Mandrake","Within the realm of " +
                ...
                "maddened hacking of flesh with grossly out-sized surgical blades.",12);
        setElites(true);
        setInfantry(true);
        setFear(true);
        setFleet(true);
