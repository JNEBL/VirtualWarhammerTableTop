 ...
 */
public class Wych extends DarkEldarModel {
    public Wych(){
        super(4,4,3,3,1,6,1,8,6,"Wych","The nightly battles " +
                ...
                "of disdain twisting into savage smiles as they feed upon each fresh scream of pain.",10);
        setTroops(true);
        setInfantry(true);
        setCombatDrug(true);
        setFleet(true);
