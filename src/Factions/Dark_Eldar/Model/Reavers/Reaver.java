 ...
 */
public class Reaver extends DarkEldarModel{
    public Reaver(){
        super(4,4,3,4,1,6,1,8,5,"Reaver","The Eldar experience " +
                ...
                "battles for the entertainment of the bloodthirsty crowd.",16);
        setFastAttack(true);
