 ...
 */
public class ClawedFiend extends DarkEldarModel{
    public ClawedFiend(){
        super(3,0,5,5,3,5,4,5,6,"Clawed Fiend","In the arenas " +
                "of Commorragh, the wild hunts of the Beastmasters are always\n" +
                ...
                "Clawed Fiend, the Beastmasters’ monstrous pets are deadly indeed.",30);
        setFastAttack(true);
        setBeasts(true);
        setNightVision(true);
        setRage(true);
