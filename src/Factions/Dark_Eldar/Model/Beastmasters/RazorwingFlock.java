 ...
 */
public class RazorwingFlock extends DarkEldarModel{
    public RazorwingFlock(){
        super(2,0,3,3,3,5,4,5,6,"Razorwing Flock","In the arenas of " +
                ...
                "Clawed Fiend, the Beastmasters’ monstrous pets are deadly indeed.",20);
        setBeasts(true);
        setFastAttack(true);
        setNightVision(true);
        setRending(true);
