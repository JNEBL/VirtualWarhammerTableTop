 ...
 */
public class Syren extends DarkEldarModel {
    public Syren(){
        super(4,4,3,3,1,6,3,9,6,"Syren","The nightly battles " +
                ...
                "of disdain twisting into savage smiles as they feed upon each fresh scream of pain.",23);
        setElites(true);
        setInfantry(true);
        setCharacters(true);
        setCombatDrug(true);
