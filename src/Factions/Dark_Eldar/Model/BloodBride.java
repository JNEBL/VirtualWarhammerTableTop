 ...
 */
public class BloodBride extends DarkEldarModel {
    public BloodBride(){
        super(4,4,3,3,1,6,2,9,6,"Bloodbride","The nightly battles " +
                ...
                "of disdain twisting into savage smiles as they feed upon each fresh scream of pain.",13);
        setElites(true);
        setInfantry(true);
        setCombatDrug(true);
        setFleet(true);
